...
import 'package:aimbiz360/Helper/AppBtn.dart';
import 'package:aimbiz360/Helper/Color.dart';
import 'package:aimbiz360/Helper/Constant.dart';
import 'package:aimbiz360/Helper/Session.dart';
import 'package:aimbiz360/Helper/SimBtn.dart';
import 'package:aimbiz360/Helper/String.dart';
import 'package:aimbiz360/Model/Model.dart';
import 'package:aimbiz360/Model/Section_Model.dart';
import 'package:aimbiz360/Provider/CartProvider.dart';
import 'package:aimbiz360/Provider/CategoryProvider.dart';
import 'package:aimbiz360/Provider/FavoriteProvider.dart';
import 'package:aimbiz360/Provider/HomeProvider.dart';
import 'package:aimbiz360/Provider/SettingProvider.dart';
import 'package:aimbiz360/Provider/UserProvider.dart';
import 'package:aimbiz360/Screen/SellerList.dart';
import 'package:aimbiz360/Screen/Seller_Details.dart';
import 'package:aimbiz360/Screen/SubCategory.dart';
...
class _HomePageState extends State<HomePage>
  ...
  getCategories() async{
    ...
    var request = http.MultipartRequest('POST', Uri.parse(getCatApi.toString()));
    ...
    if (response.statusCode == 200) {
      ...
      var finalResponse = CategoryModel.fromJson(result);
      setState(() {
        categories = finalResponse.data!;
      });
      print("this is category data ${categories.length}");
      // setState(() {
